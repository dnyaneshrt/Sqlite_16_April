package com.tech.employeedetails
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //step 1:create databaae with the help of openOrCreateDatabase Method
...
// delete()
        ...
        btn_insert.setOnClickListener {
            ...
            var status =
                sqlitedatabse.insert("AndroidBatch", null, cv)//insert() method to insert data
